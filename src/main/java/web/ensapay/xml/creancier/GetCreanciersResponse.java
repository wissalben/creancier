 ...
 *       &lt;sequence>
 *         &lt;element name="creditors" type="{http://www.ensapay.com/xml/creancier}creancier" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GetCreanciersResponse {
    ...
    protected List<Creancier> creditors;
     ...
     * 
     */
    public List<Creancier> getCreditors() {
        if (creditors == null) {
            creditors = new ArrayList<Creancier>();
        }
        return this.creditors;
    }

	public void setCreditors(List<Creancier> creditors) {
